...
if ($payr) {
    ...
    $res = $empire->query("insert into {$dbtbpre}enewspayapi set paytype='$paytype',myorder=0,payfee='0',payuser='paysapi app key',partner='',paykey='paysapi app secret',paylogo='https://jlpay.jinlisoft.kr/img/partner_alipay.jpeg',paysay='paysapi提供的支付宝支付',payname='支付宝支付',isclose=0,payemail='',paymethod=0");
...
if ($payr) {
    ...
    $res = $empire->query("insert into {$dbtbpre}enewspayapi set paytype='$paytype',myorder=0,payfee='0',payuser='paysapi app key',partner='',paykey='paysapi app secret',paylogo='https://jlpay.jinlisoft.kr/img/partner_alipay.jpeg',paysay='paysapi提供的支付宝(不挂机)支付',payname='支付宝支付',isclose=0,payemail='',paymethod=0");
...
if ($payr) {
    ...
    $res = $empire->query("insert into {$dbtbpre}enewspayapi set paytype='$paytype',myorder=0,payfee='0',payuser='paysapi app key',partner='',paykey='paysapi app secret',paylogo='https://jlpay.jinlisoft.kr/img/partner_wxpay.jpeg',paysay='paysapi提供的微信支付',payname='微信支付',isclose=0,payemail='',paymethod=0");
